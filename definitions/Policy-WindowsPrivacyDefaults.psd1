    ...
    Categories = @(
        ...
        @{
            ...
            Sections    = @(
                ...
                @{
                    ...
                    Description = 'Controls the volume of diagnostic data Windows collects on this device'
                    Settings    = @(
                        @{
        ...
        @{
            ...
            Sections    = @(
                ...
                @{
                    Name        = 'File Explorer'
                    Description = 'Controls activity records and account-driven content in File Explorer'
                    Settings    = @(
                        @{
        ...
        @{
            ...
            Sections    = @(
                ...
                # -- Section: Sign-in & Session --
                @{
                    Name        = 'Sign-in & Session'
                    Description = 'Controls sign-in behavior and local account authentication defaults'
                    Settings    = @(
                        @{
